        ...
        <div class="row tab-space1">
            <div class="col-lg-6 col-md-12">
                <div class="img-overlay-70 img-scale-animate mb-2">
                    <img src="frontend/img/news/news1.jpg" alt="news" class="img-fluid width-100">
                    <div class="mask-content-lg">
                        ...
                        <h1 class="title-medium-light">
                            <a href="single-news-1.html">If Obama Had Governed Like This in 2017 Hed Be the Transformational.</a>
                        </h1>
                    </div>
                </div>
            </div>
                ...
                <div class="row tab-space1">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="img-overlay-70 img-scale-animate mb-2">
                            ...
                            <img src="frontend/img/news/news3.jpg" alt="news" class="img-fluid width-100">
                        </div>
                    </div>
                    <div class="col-sm-6 col-12">
                        <div class="img-overlay-70 img-scale-animate mb-2">
                            ...
                            <img src="frontend/img/news/news4.jpg" alt="news" class="img-fluid width-100">
                        </div>
                    </div>
                </div>
            </div>
