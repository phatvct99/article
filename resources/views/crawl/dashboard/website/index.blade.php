...
<div class="col-12">
    <div class="card">
        ...
        <h3 class="card-header">
            Thông tin bài viết
            <td colspan="9"><a href=" {{ route('backend.websites.create') }}" class="btn btn-outline-light float-right">Thêm mới</a></td>
        </h3>
            ...
            <div class="table-responsive">
                <table id="example" class="table table-striped table-bordered second" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-sm btn-outline-light"><a href="{{  route('backend.websites.edit', $website->id) }}"><i class="far fa-edit"></i></a></button>
                            <button class="btn btn-sm btn-outline-light"><a href="{{  route('backend.websites.delete', $website->id) }}"><i class="far fa-trash-alt"></i></a></button>
                        </td>
                    </tr>
                    @endforeach
                    @endif
